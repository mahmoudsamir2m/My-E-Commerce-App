    ...
    <footer className="bg-black text-white pt-20">
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-10 pb-16 border-b border-gray-800">
          ...
          <div>
            <h3 className="text-2xl font-bold mb-6">PrimeStore</h3>
            ...
            <div className="email-input-group flex border-b border-white items-center pb-1">
              <input
                ...
                className="bg-transparent border-none text-white placeholder-gray-400 focus:outline-none w-full text-sm py-1 pr-2"
              />
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-400">
              ...
              <li>
                <a
                  href="mailto:primestore@gmail.com"
                  className="hover:text-primary-red"
                >
                  primestore@gmail.com
                </a>
              </li>
              <li>
                <a
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li>
                <a
                  href="#"
                  className="hover:text-primary-red transition duration-150 text-gray-400"
                >
                  My Account
                </a>
              </li>
          ...
          <div>
            ...
            <div className="flex items-start space-x-2">
              {/* <!-- QR Code Placeholder --> */}
              <img
                src="https://placehold.co/100x100/1A1A1A/FAFAFA?text=QR+Code"
                alt="QR Code"
                className="w-24 h-24"
              />
            ...
            <div className="flex space-x-6 mt-6 text-xl">
              <a
                href="#"
                className="hover:text-primary-red transition duration-150"
              >
                <FaFacebookF />
              </a>
              <a
