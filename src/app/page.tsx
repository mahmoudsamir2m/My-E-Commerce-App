    ...
    <>
      <section className="mt-15">
                ...
                >
                  <Card>
                    ...
                    <CardFooter className="gap-1">
                      <AddToCart
                        productId={product._id}
                        className="grow md:grow-0 px-4 bg-black w-full rounded-b-none cursor-pointer text-sm"
                      />
                    </CardFooter>
                  </Card>
                </CarouselItem>
        ...
        <div className="flex justify-center mt-5 mb-8">
          <Link
            className="bg-red-500 hover:bg-red-600 text-white p-3.5 rounded"
            href={"/products"}
          >
            View All Products
          </Link>
        ...
        <div className="max-w-7xl mx-auto py-12 md:py-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 sm:gap-16 lg:gap-20">
            ...
            <div className="text-center">
              ...
              <div
                className="w-20 h-20 flex items-center justify-center rounded-full border-4 border-soft-gray bg-primary-black mx-auto mb-6 
